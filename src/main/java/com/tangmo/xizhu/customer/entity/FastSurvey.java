...
public class FastSurvey {
    ...
    @ApiModelProperty(value="申请时间",name="applyDate",example="")
    ...
    @ApiModelProperty(value="联系电话",name="mobile",example="123456789")
    ...
    @ApiModelProperty(value="处理方案",name="solution",example="123456789")
    private String solution;//处理方案
    @ApiModelProperty(value="处理结果",name="result",example="123456789")
