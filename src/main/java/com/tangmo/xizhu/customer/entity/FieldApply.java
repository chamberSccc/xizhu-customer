...
public class FieldApply {
    ...
    @ApiModelProperty(value="现场申请人",name="applyUser",example="张三")
    private String applyUser;//现场申请人
    @ApiModelProperty(value="现场申请时间",name="fieldApplyDate",example="2019-08-03")
    ...
    @ApiModelProperty(value="现场派单目的",name="fieldTarget",example="")
