 ...
 * @Description: 表单名常量
 **/
public class FormNameConst {
    public static final String REQUIRE = "服务任务需求单";
    public static final String FAST_FB = "快速服务反馈单";
    public static final String FAST_SURVEY = "快速服务满意度调查表";
    public static final String FIELD_APPLY = "现场服务申请单";
    public static final String FIELD_ASSIGN = "现场服务指派单";
    public static final String FIELD_FB = "现场服务反馈单";
    public static final String FIELD_SURVEY = "售后服务满意度调查表";
    ...
    public static final String EQUIP_SURVEY = "安调服务满意度调查表";
}
