...
public class TroubleType {
    ...
    // 机械问题
    private static final byte MACHINE = 0;
    // 电气问题
    private static final byte ELECTRIC = 1;

    private static final String MACHINE_CODE = "机械问题";
    private static final String ELECTRIC_CODE = "电气问题";
